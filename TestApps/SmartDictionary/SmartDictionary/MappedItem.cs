...
namespace SmartDictionary
{
    public class MappedItem : INotifyPropertyChanged
    {
       ...
       // private ObservableCollection<string> _sourceCollection = new ObservableCollection<string>();
        public List<string> SourceCollection
        {
            get { return SourceMapCollection; }
            set {  SourceMapCollection = value; }
        }

        //private ObservableCollection<string> CalculateProperCollection()
        //{
        //    return 
        //}
